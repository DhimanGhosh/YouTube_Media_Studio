...
from youtube_audio_video_downloader.services.media_redownloader import AUDIO_EXTENSIONS, redownload_media
...
def edit_media_file(
    ...
    *,
    ...
    raise ValueError("Edit action must be Metadata only, Trim audio, or Redownload media")
