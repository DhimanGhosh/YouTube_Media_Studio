...
from youtube_audio_video_downloader.gui.runtime.crash_reporter import install_crash_reporter
from youtube_audio_video_downloader.gui.components.resources import application_icon_path
