...
from youtube_audio_video_downloader.services.album_consolidator import consolidate_albums
...
from youtube_audio_video_downloader.services.audio_trimmer import trim_audio
from youtube_audio_video_downloader.services.jukebox_splitter import YouTubeJukeboxSplitter
from youtube_audio_video_downloader.services.media_redownloader import redownload_media
...
from youtube_audio_video_downloader.services.operation_agent import preflight_operation
from youtube_audio_video_downloader.services.song_search import search_song
from youtube_audio_video_downloader.services.song_selection_enricher import enrich_selected_song
...
def _run_edit_media(params: dict[str, Any], token: CancellationToken) -> OperationSummary:
    ...
    return OperationSummary(
        ...
        total=len(output_paths),
        downloaded=len(output_paths) if action != "metadata" else 0,
